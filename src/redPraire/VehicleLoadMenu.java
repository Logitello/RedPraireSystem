...
public class VehicleLoadMenu {
	
	public VehicleLoadMenu() {
		
JFrame frame = new JFrame("RedPraire");
		
		JLabel page = new JLabel("1/1");
		JLabel title = new JLabel("VehicleLoadMenu");
		JLabel l1 = new JLabel("1 Vehicle Load");
		JLabel l2 = new JLabel("2 Vehicle Unload");
		JLabel l3 = new JLabel("3 Vehicle Reload");
