...
public class NewRelocate {
	...
	public NewRelocate() {
		...
		JLabel title = new JLabel("RelocateNewEntry");
		JLabel l1 = new JLabel("Tag");
		JLabel l2 = new JLabel("SKU");
		JLabel l3 = new JLabel("Location");
		JLabel l4 = new JLabel("Quantity");
		JLabel l5 = new JLabel("Pallet");
		...
		tfield2.setBounds(100, 42, 120, 20);
		...
		tfield4.setBounds(100, 82, 130, 20);
		...
		tfield5.setBounds(100, 102, 160, 20);
		...
		tfield6.setBounds(100, 122, 160, 20);
		...
		tfield7.setBounds(100, 142, 80, 20);
