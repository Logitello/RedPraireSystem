...
public class PreAdvReceive {
	
	public PreAdvReceive() {
		
		JFrame frame = new JFrame("RedPraire");
		
		JLabel page = new JLabel("1/1");
		JLabel title = new JLabel("GrpReceiveMenu");
		JLabel l1 = new JLabel("1 UPI Receive");
		...
		tfield.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode() == KeyEvent.VK_ENTER) {
					if(tfield.getText().contentEquals("1")) {
