...
JFrame frame = new JFrame("RedPraire");
		...
		JLabel title = new JLabel("MarshalEntry");
		JLabel l1 = new JLabel("Pallet");
		JLabel l2 = new JLabel("Work Zone");
		JLabel l3 = new JLabel("Consignment");
		JLabel l4 = new JLabel("From Location");
		JLabel l5 = new JLabel("To Location");
		...
		tfield2.setBounds(130, 42, 100, 20);
		...
		tfield3.setBounds(130, 62, 180, 20);
		...
		tfield4.setBounds(130, 82, 100, 20);
		...
		tfield5.setBounds(130, 102, 100, 20);
		...
		tfield6.setBounds(130, 122, 100, 20);
